...
export default function RightSidebar({ onHashtagClick }: RightSidebarProps) {
      ...
      <div className="bg-gray-50 rounded-xl p-4">
        <form onSubmit={handleSearchSubmit}>
          <div className="relative">
            ...
            <button
              type="submit"
              className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-[#00B67E] w-4 h-4 flex items-center justify-center cursor-pointer"
            >
        ...
        <div className="space-y-2">
          {displayedTopics.map((topic) => (
            <div 
              ...
              className="flex items-center justify-between cursor-pointer hover:bg-white rounded-lg p-2 transition-colors duration-200"
            >
              <div>
                <p className="font-medium text-[#00B67E] text-sm hover:text-[#00a06f]">{topic.hashtag}</p>
            ...
            <div key={user.id} className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-5">{user.username}</p>
                </div>
              </div>
              <button
