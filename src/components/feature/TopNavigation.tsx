            ...
            <div className="flex items-center space-x-8">
              ...
              <nav className="flex space-x-6">
                <button 
                  ...
                  className="text-gray-700 hover:text-[#00B67E] transition-colors duration-200 cursor-pointer whitespace-nowrap"
                >
                  프로젝트
                </button>
                <button 
                ...
                <button className="text-gray-700 hover:text-[#00B67E] transition-colors duration-200 cursor-pointer whitespace-nowrap">
                  배경화면
                </button>
                <button className="text-gray-700 hover:text-[#00B67E] transition-colors duration-200 cursor-pointer whitespace-nowrap">
                  크리에이터
