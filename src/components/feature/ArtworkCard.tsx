...
export default function ArtworkCard({ 
  ...
  return (
    ...
    >
      {/* Artwork Image - Large Landscape format with full rounded corners */}
      <div className="relative aspect-[4/3] overflow-hidden rounded-lg">
        ...
        <div className={`absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black/30 transition-opacity duration-300 rounded-lg ${
      ...
      {/* Bottom Info - Artist Profile + Stats - Aligned to image edges */}
      <div className="px-3 py-2 flex items-center justify-between w-full">
        {/* Artist Profile - Left aligned to image edge */}
        ...
        {/* Views and Likes - Right aligned to image edge */}
        <div className="flex items-center space-x-3 text-gray-500 text-sm flex-shrink-0">
